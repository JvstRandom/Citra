...
def main():
    ...
    print("9. Normalize Grayscale Image and Display Histograms")

    choice = int(input("Enter the number of the operation you want to perform (1-9): "))
    ...
    if choice == 1:
        ...
        show_image_with_pixels(grayscale_image, 'Grayscale Image')

        # Display histogram before normalization
        show_histogram(grayscale_image, 'Grayscale Image Before Normalization')

        # Normalize grayscale image
        normalized_image = normalize_grayscale(grayscale_image)
        show_image_with_pixels(normalized_image, 'Normalized Grayscale Image')

        # Display histogram after normalization
        show_histogram(normalized_image, 'Grayscale Image After Normalization')
